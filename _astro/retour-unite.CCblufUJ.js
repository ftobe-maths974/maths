import{ensureSharedStyles as A}from"./vis-input.0hz6aJN5.js";import{fmt as w}from"./utils.MftNdmoG.js";const R="south",S=!0;function L(f){return f.replace(/\s/g,"").replace(",",".")}function u(f,e){const t=parseFloat(L(f));return!isNaN(t)&&Math.abs(t-e)<.01}const y=`
