import{markInput as M,clearInput as C,ensureSharedStyles as L}from"./vis-input.B9XJnOtJ.js";const R="south",_="math974-division-posee",V=`
...
`;function D(){if(L(),document.getElementById("dp-styles"))return;const a=document.createElement("style");a.id="dp-styles",a.textContent=V,document.head.appendChild(a)}function q(a,t){const i=String(Math.abs(Math.round(a)));return Array.from({length:t},(l,r)=>{const d=i.length-(t-r);return d>=0?parseInt(i[d]):null})}function A(a,t){const i=String(a),l=i.length,r=[];let d=0,o=0;for(;o<l&&d<t;)d=d*10+parseInt(i[o]),o++;for(;o<=l;){const p=o-1,c=String(d),e=p-c.length+1,u=Math.floor(d/t),g=u*t,s=d-g;if(r.push({startCol:e,endCol:p,qDigit:u,product:g,remainder:s}),o>=l)break;d=s*10+parseInt(i[o]),o++}return r}const b=M,w=C;function x(a){return`<td><div class="dp-cell-wrap"><input class="dp-inp" type="text" inputmode="numeric" maxlength="1" data-sol="${a}" autocomplete="off"><span class="vis-fb"></span></div></td>`}function v(a){return`<div class="dp-cell-wrap"><input class="dp-inp dp-euc-inp" type="text" inputmode="numeric" maxlength="1" data-sol="${a}" autocomplete="off"><span class="vis-fb"></span></div>`}class z extends HTMLElement{static get observedAttributes(){return["dividend","divisor"]}connectedCallback(){D(),this.dataset.placeMode="1",this._solVisible=!1,this._render()}attributeChangedCallback(){this.isConnected&&(this._solVisible=!1,this._render())}_dividend(){return parseInt(this.getAttribute("dividend")||"0")}_divisor(){return parseInt(this.getAttribute("divisor")||"1")}_render(){const t=this._dividend(),i=this._divisor();if(!t||!i){this.innerHTML="";return}const l=String(t),r=l.length,d=A(t,i),o=String(Math.floor(t/i)),p=()=>'<td class="dp-blank"></td>',c=s=>`<td class="dp-given">${s}</td>`;let e=`<div class="dp-title">Pose et effectue : ${t} ÷ ${i}</div>`;e+='<div class="dp-outer"><table class="dp-table">',e+='<tr><td class="dp-op"></td>';for(const s of l)e+=c(parseInt(s));e+="</tr>",d.forEach((s,m)=>{const{startCol:h,endCol:f,product:E,remainder:I}=s,y=m===d.length-1,S=f-h+1,k=q(E,S).map(n=>n??0),$=q(I,S).map(n=>n??0);e+=`<tr class="dp-prod-${m} dp-hidden"><td class="dp-op">−</td>`;for(let n=0;n<r;n++){if(n<h||n>f){e+=p();continue}e+=x(k[n-h])}e+="</tr>",e+=`<tr class="dp-bar-${m} dp-bar-row dp-hidden"><td></td>`;for(let n=0;n<r;n++)e+=n>=h&&n<=f?'<td class="dp-bar-td"></td>':p();e+="</tr>",e+=`<tr class="dp-sub-${m} dp-hidden">${y?'<td class="dp-rem-label">r.</td>':'<td class="dp-op"></td>'}`;for(let n=0;n<r;n++)!y&&n===f+1?e+=x(parseInt(l[n])):n>=h&&n<=f?e+=x($[n-h]):e+=p();e+="</tr>"}),e+="</table>",e+='<div class="dp-right">',e+=`<div class="dp-right-top">${i}</div>`,e+='<div class="dp-right-quot">';for(let s=0;s<o.length;s++)e+=`<div class="dp-cell-wrap"><input class="dp-inp dp-quot-inp" type="text" inputmode="numeric" maxlength="1" data-sol="${o[s]}" data-qi="${s}" autocomplete="off"><span class="vis-fb"></span></div>`;e+="</div></div></div>";const u=Math.floor(t/i),g=t-i*u;e+='<div class="dp-euclidean dp-hidden">',e+=`<div class="dp-euc-inputs">${Array.from(String(t)).map(s=>v(s)).join("")}</div>`,e+='<span class="dp-euc-op">=</span>',e+=`<div class="dp-euc-inputs">${Array.from(String(i)).map(s=>v(s)).join("")}</div>`,e+='<span class="dp-euc-op">×</span>',e+=`<div class="dp-euc-inputs">${Array.from(String(u)).map(s=>v(s)).join("")}</div>`,e+='<span class="dp-euc-op">+</span>',e+=`<div class="dp-euc-inputs">${Array.from(String(g)).map(s=>v(s)).join("")}</div>`,e+="</div>",this.innerHTML=e,this.querySelectorAll(".dp-quot-inp").forEach(s=>{s.addEventListener("input",()=>this._updateVisibility())}),d.forEach((s,m)=>{this.querySelector(`.dp-prod-${m}`)?.querySelectorAll(".dp-inp").forEach(f=>{f.addEventListener("input",()=>this._updateVisibility())})}),this.querySelectorAll(".dp-euc-inp").forEach(s=>{s.addEventListener("input",()=>this._checkAutoValidateEuc())}),this._updateVisibility(),this._solVisible&&this._revealAll()}_updateVisibility(){const t=A(this._dividend(),this._divisor()),i=Array.from(this.querySelectorAll(".dp-quot-inp"));t.forEach((r,d)=>{const o=i[d]?.value.trim()!=="",p=this.querySelector(`.dp-prod-${d}`),c=this.querySelector(`.dp-bar-${d}`),e=this.querySelector(`.dp-sub-${d}`);p?.classList.toggle("dp-hidden",!o),c?.classList.toggle("dp-hidden",!o);const u=Array.from(p?.querySelectorAll(".dp-inp")||[]),g=o&&u.every(s=>s.value.trim()!=="");e?.classList.toggle("dp-hidden",!g)}),Array.from(this.querySelectorAll(".dp-inp:not(.dp-euc-inp)")).every(r=>r.value.trim()!=="")&&this._validateMain()}_validateMain(){let t=!0;this.querySelectorAll(".dp-inp:not(.dp-euc-inp)").forEach(i=>{const l=i.value.trim()===""?null:parseInt(i.value.trim());if(l===null){t=!1;return}const r=l===parseInt(i.dataset.sol);b(i,r),r||(t=!1)}),t&&this.querySelector(".dp-euclidean")?.classList.remove("dp-hidden")}_checkAutoValidateEuc(){Array.from(this.querySelectorAll(".dp-euc-inp")).every(i=>i.value.trim()!=="")&&this._validateEuc()}_validateEuc(){this.querySelectorAll(".dp-euc-inp").forEach(t=>{const i=t.value.trim()===""?null:parseInt(t.value.trim());if(i===null){w(t);return}b(t,i===parseInt(t.dataset.sol))})}validate(){this._validateMain(),this.querySelector(".dp-euclidean")?.classList.contains("dp-hidden")||this._validateEuc()}_revealAll(){this.querySelectorAll(".dp-hidden").forEach(t=>t.classList.remove("dp-hidden")),this.querySelectorAll(".dp-inp").forEach(t=>{t.value=t.dataset.sol,b(t,!0)})}toggleSolution(){return this._solVisible=!this._solVisible,this._solVisible?this._revealAll():(this.querySelector(".dp-euclidean")?.classList.add("dp-hidden"),this.querySelectorAll(".dp-inp").forEach(t=>{t.value="",w(t)}),this._updateVisibility()),this._solVisible}}customElements.get(_)||customElements.define(_,z);function P(a,t){const i=t.dividendDigits??3,l=t.divisorDigits??1,r=l===1?2:10**(l-1),d=10**l-1,o=Math.floor(Math.random()*(d-r+1))+r,p=Math.max(o*10,10**(i-1)),c=10**i-1,e=Math.floor(Math.random()*(c-p+1))+p;return{...a,dividend:e,divisor:o}}export{R as defaultPosition,P as randomize};
