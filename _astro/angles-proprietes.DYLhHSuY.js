import{F as g}from"./figure-colors.CJg3xQS9.js";import{parseRange as C}from"./utils.MftNdmoG.js";const N="north",T=!0,U=!0,M=210,v=165,f=M/2,b=v/2;function R(n){return n*Math.PI/180}function r(n,t){return[f+t*Math.cos(R(n)),b+t*Math.sin(R(n))]}function $(n,t){return`<line x1="${n[0].toFixed(1)}" y1="${n[1].toFixed(1)}"
