const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["_astro/rapido-engine.zds87zZq.js","_astro/rapidos-visuals-integration.CzBQUPwI.js","_astro/editor.CJZspgfY.js","_astro/vis-input.DWZqpaF9.js"])))=>i.map(i=>d[i]);
import{_ as y}from"./editor.CJZspgfY.js";import{ensureSharedStyles as I}from"./vis-input.DWZqpaF9.js";import{parseFormula as v,evaluate as k,parseRef as w,idxToCol as S,formatValue as M,shiftRefs as A,stringify as R,astEqual as z}from"./formula-parser.CuBpGvtX.js";import"./rapido-engine.zds87zZq.js";import"./rapidos-visuals-integration.CzBQUPwI.js";const V="south",W=!1,L="math974-spreadsheet-css",T=`
math974-spreadsheet {
  display: block;
  font-family: inherit;
  width: 100%;
...
/* Borne le scaling du .content parent quand un visuel spreadsheet y est
   monte — sinon le clamp(--q-text-size) global atteint 4rem en FS et
   l'enonce chevauche le tableur. La regle s'applique au .variant-content
   marque .ss-variant par le composant. */
.variant-content.ss-variant > .content {
  font-size: clamp(0.95rem, 2.8cqi, 1.5rem);
  line-height: 1.35;
}
.ss-wrap {
  overflow: auto;
