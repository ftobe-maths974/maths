const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["_astro/rapido-engine.BEIqVwWr.js","_astro/rapidos-visuals-integration.C-5Lgf1L.js","_astro/editor.CJZspgfY.js","_astro/vis-input.zCKKR56f.js"])))=>i.map(i=>d[i]);
import{_ as y}from"./editor.CJZspgfY.js";import{ensureSharedStyles as I}from"./vis-input.zCKKR56f.js";import{parseFormula as v,evaluate as k,parseRef as w,idxToCol as S,formatValue as M,shiftRefs as A,stringify as R,astEqual as z}from"./formula-parser.CuBpGvtX.js";import"./rapido-engine.BEIqVwWr.js";import"./rapidos-visuals-integration.C-5Lgf1L.js";const V="east",W=!1,L="math974-spreadsheet-css",T=`
math974-spreadsheet {
  display: block;
  font-family: inherit;
  width: 100%;
...
/* Mode classe (grille 2x3, cards vignettes ~480px) : on NE veut PAS le
   layout 3 colonnes — bascule en vertical (east passe en bas).
   :not(.q-card--fs) exclut les cards promues en FS au clic ▶, qui doivent
   garder leur layout 3 colonnes (la card devient pleine fenêtre). */
body.classe-mode .q-card.has-visual-east:not(.q-card--fs) {
...
body.classe-mode .q-card.has-visual-east:not(.q-card--fs) > .q-card-east {
  width: 100%;
  display: block;
}
.ss-wrap {
