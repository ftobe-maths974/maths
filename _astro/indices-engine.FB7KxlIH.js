const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["_astro/rapido-engine.vKEIXvMi.js","_astro/rapidos-visuals-integration.t3lOhgO8.js","_astro/editor.CJZspgfY.js","_astro/error-detector.DbwyYFEG.js"])))=>i.map(i=>d[i]);
import{_ as x}from"./editor.CJZspgfY.js";import{T as A,j as E}from"./rapido-engine.vKEIXvMi.js";import"./rapidos-visuals-integration.t3lOhgO8.js";const C=`# Matrice d'indices — fiche 24.04 retour à l'unité (cycle 3)
#
...
variantes:
  ...
  # ─────────────────────────────────────────────────────────────────────────
  # Variantes TABLEUR (groupe 5 — visuel \`spreadsheet\`, GS 24.4 cycle 4)
  # ─────────────────────────────────────────────────────────────────────────
...
`,T=`# Matrice d'indices — Zefor 04-tableur-dnb (style DNB 3e)
#
...
`,M=`# Indices Zefor 05-tableur-vocabulaire
#
# 9 variantes (1 identify-zones + 8 manipulations B). Tonalité socratique.
...
variantes:
  ...
  cell-click-c5:
    phases:
      cellule_vide:
        n1: "Clique sur la cellule demandée dans le tableur."
        n2: "Une adresse comme \`C5\` : la **lettre** indique la **colonne**, le **chiffre** indique la **ligne**."
        n3: "Colonne **C** = la 3ᵉ colonne. Ligne **5** = la 5ᵉ ligne. Clique à l'intersection."
      erreur_calcul:
        n1: "La cellule que tu as cliquée n'est pas la bonne. Vérifie la colonne et la ligne."
        n2: "Rappelle-toi : la lettre = colonne, le chiffre = ligne. C5 = colonne C, ligne 5."
        n3: "Clique exactement sur l'intersection de la colonne C et de la ligne 5."

  cell-click-d3:
    phases:
      cellule_vide:
        n1: "Cherche la colonne **D**, puis la ligne **3**, et clique à l'intersection."
      erreur_calcul:
        n1: "Vérifie : D = 4ᵉ colonne, ligne 3 = 3ᵉ ligne."

  # ── B.2 range-drag ─────────────────────────────────────────────────────
  range-drag-b2d4:
    phases:
      cellule_vide:
        n1: "Pour sélectionner une plage, **maintiens** le clic sur la première cellule, puis **glisse** jusqu'à la dernière."
        n2: "B2:D4 = de B2 (en haut à gauche) jusqu'à D4 (en bas à droite). Ça fait un rectangle de 3 colonnes × 3 lignes."
        n3: "Pose ton doigt sur B2, glisse jusqu'à D4 sans relâcher."
      erreur_calcul:
        n1: "Ta sélection n'est pas la bonne plage. Vérifie les 2 coins (le début et la fin)."
        n2: "B2:D4 → coin haut-gauche = B2, coin bas-droit = D4."

  range-drag-a1c1:
    phases:
      cellule_vide:
        n1: "A1:E1 c'est toute la ligne 1, de A à E. Glisse de A1 jusqu'à E1."
      erreur_calcul:
        n1: "Vérifie : tu dois aller de A1 (à gauche) jusqu'à E1 (à droite) sur la même ligne."
  ...
  cell-name-d4:
    ...
    phases:
      cellule_vide:
        n1: "Regarde la **colonne** (lettre) et la **ligne** (chiffre) de la cellule en bleu."
        n2: "Une adresse = LETTRE + CHIFFRE, sans espace. Exemple : A1, C5, F12."
        n3: "La cellule sélectionnée est à l'intersection de la colonne D et de la ligne 4. Son adresse est \`D4\`."
      erreur_calcul:
        n1: "Vérifie : as-tu bien repéré la colonne (lettre) ET la ligne (chiffre) ?"

  cell-name-b6:
    patterns_formule:
      - id: confusion_ligne_colonne
        formula_regex: "^\\\\d+[A-Za-z]+$"
        indice: "On écrit **la lettre d'abord**, puis le chiffre. Exemple \`B6\`, pas \`6B\`."
        relance: "Réessaie."
    phases:
      cellule_vide:
        n1: "Lettre + chiffre. La cellule est sur la colonne… et la ligne… ?"
  ...
  range-name-c2e5:
    patterns_formule:
      ...
      - id: plage_inversee
        formula_regex: "^[A-Za-z]+\\\\d+:[A-Za-z]+\\\\d+$"
        indice: "Une plage s'écrit **du coin haut-gauche au coin bas-droit**. Vérifie l'ordre de tes deux refs."
        relance: "Reformule depuis le coin en haut à gauche."
      - id: confusion_ligne_colonne
        formula_regex: "^\\\\d+[A-Za-z]+:"
    ...
    phases:
      cellule_vide:
        ...
        n2: "Le coin haut-gauche est C2. Le coin bas-droit est E5. Ça donne ?"
        n3: "Tape \`C2:E5\`."
  ...
  range-name-a1c3:
    patterns_formule:
      - id: oubli_deux_points
        formula_regex: "^[A-Za-z]+\\\\d+\\\\s*[;,]\\\\s*[A-Za-z]+\\\\d+$"
        indice: "Les deux refs d'une plage sont séparées par \`:\` (deux-points)."
        relance: "Remplace par \`:\`."
    phases:
      cellule_vide:
        n1: "Repère le coin en haut à gauche, puis le coin en bas à droite. Sépare-les par \`:\`."
        n3: "Tape \`A1:C3\`."
  ...
  satisf-schema-entiers:
    ...
    erreurs_types:
      ...
      - id: dissymetrie_facteurs
        ...
        cible_phase: div_droite|mult_droite
        indice: "Dans un tableau de proportionnalité, **le même facteur** apparaît à gauche et à droite. Vérifie."
`,h=Object.assign({"../data/indices/01-retour-unite.yaml":C,"../data/indices/02-graduer-axe-fraction.yaml":L,"../data/indices/04-tableur-dnb.yaml":T,"../data/indices/05-tableur-vocabulaire.yaml":M,"../data/indices/24.04-retour-unite.yaml":R}),$=(()=>{const e={};for(const n of Object.keys(h)){const a=n.match(/\/([^/]+)\.yaml$/)?.[1];if(a)try{e[a]=E.load(h[n])}catch(t){console.error(`[indices] erreur de parsing ${n}:`,t)}}return e})();function q(e){return e?e.split("/").pop():""}function B(e,n){const a=$[q(e)];return a?.variantes?a.variantes[n]??null:null}function j(e){const n=e?.dataset?.ref;if(!n)return!1;const t=e.querySelector(".variant-content.active")?.dataset?.id;return t?!!B(n,t):!1}function y(e){for(const n of e.querySelectorAll("*"))if(typeof n.getCurrentPhase=="function")return n;return null}async function g(e,n){if(!e)return"";const a=new A;a.reset(),Object.entries(n).forEach(([r,i])=>{(typeof i=="number"||i&&typeof i=="object"&&!Array.isArray(i))&&a.variables.set(r,i)});const t=a.parse(e,"web"),{miniMd:d}=await x(async()=>{const{miniMd:r}=await import("./rapido-engine.vKEIXvMi.js").then(i=>i.f);return{miniMd:r}},__vite__mapDeps([0,1,2]));return d(t)}async function N(e,n={level:1}){const a=e?.dataset?.ref;if(!a)return null;const t=e.querySelector(".variant-content.active"),d=t?.dataset?.id;if(!d)return null;const r=B(a,d),i=y(e),l=i?.getCurrentPhase?.()??"initial";if(l==="done")return{html:"Tu as déjà tout bon ici. Bravo !",phase:l,level:1,isDone:!0};const p=t?.visualData?.config??{},c=Math.min(Math.max(n.level|0,1),3);if(l==="erreur_reponse_directe")try{const{detectErrorPattern:u}=await x(async()=>{const{detectErrorPattern:f}=await import("./error-detector.DbwyYFEG.js");return{detectErrorPattern:f}},__vite__mapDeps([3,0,1,2])),m=i?.querySelector?.(".rapido-input")?.value??"",o=u({ref:q(a),variantId:d,studentValue:m,vars:p});if(o){const b=c===2&&o.relance||o.indice;return{html:await g(b,p),phase:l,level:c,isDone:!1,patternId:o.id}}}catch(u){console.error("[indices] error-detector:",u)}if(r?.patterns_formule&&typeof i?.getCurrentStudentValue=="function")try{const u=i.getCurrentStudentValue()||"";for(const s of r.patterns_formule){if(!s.formula_regex)continue;let m;try{m=new RegExp(s.formula_regex,s.flags??"i")}catch{continue}if(m.test(u)){const f=c===2&&s.relance||s.indice;return{html:await g(f,p),phase:l,level:c,isDone:!1,patternId:s.id}}}}catch(u){console.error("[indices] patterns_formule:",u)}if(!r)return null;const _=r.phases?.[l];if(!_)return null;const v=_[`n${c}`];return v?{html:await g(v,p),phase:l,level:c,isDone:!1}:null}export{j as cardHasIndices,N as getNextIndice};
