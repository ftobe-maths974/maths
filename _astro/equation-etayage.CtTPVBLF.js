import{l as _}from"./rapidos-visuals-integration.jQawOiEP.js";import"./editor.CJZspgfY.js";const C="content",L=!0,p=(n,e)=>Math.floor(Math.random()*(e-n+1))+n,m=(n,e)=>{let t;do t=p(n,e);while(t===0);return t};function E(n){const e=n&&n.form||"ax+b=c";if(e==="ax=b"){const o=p(2,7),c=p(2,9);return{...n,equation:`${o}x = ${o*c}`,_seed:Math.random()}}if(e==="x+a=b"){const o=p(1,9),c=p(2,9);return{...n,equation:`x + ${o} = ${o+c}`,_seed:Math.random()}}if(e==="x+a=b-relatif"){let o,c,s;do o=m(-9,9),c=m(-9,9),s=c+o;while(s===0||Math.abs(s)>12);const l=o<0?` - ${-o}`:` + ${o}`;return{...n,equation:`x${l} = ${s}`,_seed:Math.random()}}const t=p(2,7),r=p(2,7),i=p(1,9),a=t*r+i;return{...n,equation:`${t}x + ${i} = ${a}`,_seed:Math.random()}}const k=`
.ee-wrap {
  padding: 12px 8px;
  margin: 0 auto;
...
/* La variable x rendue en italique mathematique (LaTeX-like) : police
   serif math, italique, poids attenue pour rester lisible en contexte bold. */
.ee-var {
  font-style: italic;
