import{_ as P}from"./preload-helper.CL8WEfgq.js";import{r as k}from"./editor.Di92v2Ao.js";let f=null,b=!1,g=new Map,l=null;async function S(e){if(f)return f;const t=await P(()=>import("./pdf.Cq_gInFy.js"),[]);return t.GlobalWorkerOptions.workerSrc=new URL("/maths/_astro/pdf.worker.min.FHbmGBN0.mjs",import.meta.url).href,f=t,t}function U(e){if(g.has(e))return g.get(e);const t=S().then(r=>r.getDocument(e).promise);return g.set(e,t),t}function D(){if(b)return;b=!0;const e=`
    .gs-pdf-overlay {
