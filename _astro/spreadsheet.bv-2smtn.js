const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["_astro/rapido-engine.CMPXk0MX.js","_astro/rapidos-visuals-integration.EWD3xC8Z.js","_astro/editor.CJZspgfY.js","_astro/vis-input.BLjHHsLM.js"])))=>i.map(i=>d[i]);
import{_ as M}from"./editor.CJZspgfY.js";import{ensureSharedStyles as j}from"./vis-input.BLjHHsLM.js";import{idxToCol as R,formatValue as A,colToIdx as I,parseFormula as L,stringify as T,shiftRefs as N,parseRef as q,evaluate as F,astEqual as O}from"./formula-parser.CuBpGvtX.js";import"./rapido-engine.CMPXk0MX.js";import"./rapidos-visuals-integration.EWD3xC8Z.js";const te="east",se=!0,B="math974-spreadsheet-css",H=`
math974-spreadsheet {
  display: block;
  font-family: inherit;
...
`;function V(){if(document.getElementById(B))return;const v=document.createElement("style");v.id=B,v.textContent=H,document.head.appendChild(v)}function P(v,e){if(!v)return e;try{return JSON.parse(v)}catch{return e}}function w(v,e){return R(v)+(e+1)}function G(v){let e=String(v);const t=[],s=/\[([^\]]*)\]$/;let r;for(;r=s.exec(e);)t.unshift(r[1]),e=e.slice(0,e.length-r[0].length);let n=null;const l={l:0,r:0,u:0,d:0};let o=!1;for(const a of t){if(a==="r"||a==="c"||a==="l"){n=a;continue}for(const i of a)i===">"?(l.r++,o=!0):i==="<"?(l.l++,o=!0):i==="^"?(l.u++,o=!0):i==="v"&&(l.d++,o=!0)}return{base:e,align:n,merge:o?l:null}}function Z(v){return(v||"").trim()}class W extends HTMLElement{static get observedAttributes(){return["rows","cols","cells","locked","solutions","headers","mode","preset","chart"]}constructor(){super(),this._cells=new Map,this._values=new Map,this._selected=null,this._undo=[],this._activeInput=null,this._currentPhase="cellule_vide",this._mode="formula",this._zonePairs=new Map,this._zoneSolved=new Set,this._activeBadge=null,this._currentTarget=""}connectedCallback(){V(),j(),this.closest(".variant-content")?.classList.add("ss-variant"),this.closest(".q-card")?.classList.add("has-ss"),this.getAttribute("mode")==="identify-zones"&&(this._autoScaleRO={disconnect:()=>{}}),this._render(),this._wireDocLevelListeners()}attributeChangedCallback(){this.isConnected&&this._render()}validate(){if(this._mode==="identify-zones")return this._zoneSolved.size===this._zonePairs.size&&this._zonePairs.size>0;if(this._mode==="cell-click"||this._mode==="range-drag")return this._userSelectionText().toUpperCase()===(this._currentTarget||"").trim().toUpperCase();if(this._mode==="cell-name"||this._mode==="range-name"){const s=(this.querySelector(".ss-name-input")?.value||"").trim().toUpperCase(),r=(this._currentTarget||"").trim().toUpperCase();return s===r&&r!==""}const e=this._targetCells();return e.length===0?!1:e.every(t=>this._isCorrect(t))}toggleSolution(){if(this._mode==="identify-zones"){this._zonePairs.forEach((e,t)=>{const s=this.querySelector(`.ss-zone-badge[data-zone-id="${t}"]`),r=Array.from(this.querySelectorAll(".ss-vocab-pill")).find(n=>n.dataset.label===e);s?.classList.remove("ss-zone-active-sel"),s?.classList.add("ss-zone-ok"),r?.classList.add("ss-pill-used"),r&&(r.disabled=!0),this._zoneSolved.add(t)}),this._updateZoneStatus(),this._updatePhase();return}this._showSolutions=!this._showSolutions,this._renderGrid()}getCurrentPhase(){return this._currentPhase}getCurrentStudentValue(){if(this._mode==="cell-click"||this._mode==="range-drag")return this._userSelectionText();if(this._mode==="cell-name"||this._mode==="range-name")return this.querySelector(".ss-name-input")?.value||"";if(this._activeInput){const e=this._activeInput.dataset.ssRef,t=this._cells.get(e);return t?.raw?t.raw:this._activeInput.value||""}for(const e of this._targetCells()){const t=this._cells.get(e);if(t?.raw&&!this._isCorrect(e))return t.raw}return""}_displayValueForFill(e,t){if(e?.target&&e.raw&&e.raw.startsWith("=")){const s=this._values.get(t);if(s!=null&&!(typeof s=="object"&&s.error))return A(s)}return e?.raw||""}_validateCell(e){if(this._mode==="cell-name"||this._mode==="range-name"){const s=(e.value||"").trim().toUpperCase(),r=(this._currentTarget||"").trim().toUpperCase();return s===r&&r!==""}const t=e.dataset.ssRef;return t?this._isCorrect(t):!1}_readFormula(e){const t=e.dataset.ssRef;return t&&this._cells.get(t)?.raw||""}_readAttrs(){this._rows=Math.max(1,parseInt(this.getAttribute("rows")||"6",10)),this._cols=Math.max(1,parseInt(this.getAttribute("cols")||"5",10));const e=P(this.getAttribute("cells"),{}),t=new Set(P(this.getAttribute("locked"),[])),s=P(this.getAttribute("solutions"),{}),r=P(this.getAttribute("headers"),null);this._declaredMode=this.getAttribute("mode")||"formula",this._mode=this._declaredMode,this._preset=P(this.getAttribute("preset"),null),this._chart=P(this.getAttribute("chart"),null);const n=/^([A-Z]+\d+)$/,l=/^([A-Z]+)(\d+):([A-Z]+)(\d+)$/;this._cells.clear();for(const[i,c]of Object.entries(e)){const{base:u,align:m,merge:d}=G(i),b=c==null?"":String(c),f=l.exec(u);if(f){const p=I(f[1]),y=I(f[3]),S=parseInt(f[2],10)-1,C=parseInt(f[4],10)-1;for(let E=S;E<=C;E++)for(let _=p;_<=y;_++){const k=w(_,E),z={raw:b,locked:t.has(k),align:m};this._parseIntoCell(z),this._cells.set(k,z)}continue}const g=n.exec(u),h=g?g[1]:u,x={raw:b,locked:t.has(h),align:m,merge:d};this._parseIntoCell(x),this._cells.set(h,x)}for(const i of t)this._cells.has(i)||this._cells.set(i,{raw:"",locked:!0});const o=/^([A-Z]+)(\d+):([A-Z]+)(\d+)$/,a=(i,c,u)=>({formula:i,mode:u.mode||"formula",alt:Array.isArray(u.alt)?u.alt:[],fillOnly:c,maxDollars:typeof u.maxDollars=="number"?u.maxDollars:null});for(const[i,c]of Object.entries(s)){const u=o.exec(i);if(u){const d=c.formula||c,b=L(d);if(!b||b.error){console.warn("[spreadsheet] solutions range : formule invalide",d);continue}const f=I(u[1]),g=I(u[3]),h=parseInt(u[2],10)-1,x=parseInt(u[4],10)-1;for(let p=h;p<=x;p++)for(let y=f;y<=g;y++){const S=w(y,p),C=y===f&&p===h,E=C?d:T(N(b,y-f,p-h));let _=this._cells.get(S);_||(_={raw:"",locked:!1},this._cells.set(S,_)),_.target=!0,_.sol=a(E,!C,c)}continue}let m=this._cells.get(i);m||(m={raw:"",locked:!1},this._cells.set(i,m)),m.target=!0,m.sol=a(c.formula||c,!!c.fillOnly,c)}this._headers=r,this._computeMerges()}_computeMerges(){this._mergeSpans=new Map,this._mergeCovered=new Set;const e=[];for(const[t,s]of this._cells)s.merge&&e.push([t,s]);for(const[t,s]of e){const r=q(t);if(!r)continue;const n=s.merge,l=Math.max(0,r.col-(n.l||0)),o=Math.min(this._cols-1,r.col+(n.r||0)),a=Math.max(0,r.row-(n.u||0)),i=Math.min(this._rows-1,r.row+(n.d||0)),c=o-l+1,u=i-a+1;if(c<=1&&u<=1)continue;const m=w(l,a);m!==t&&this._cells.set(m,s),this._mergeSpans.set(m,{colspan:c,rowspan:u});for(let d=a;d<=i;d++)for(let b=l;b<=o;b++){const f=w(b,d);f!==m&&this._mergeCovered.add(f)}}}_parseIntoCell(e){delete e.ast,delete e.parseError;const t=e.raw;if(typeof t=="string"&&t.trim().startsWith("=")){const s=L(t);s.error?e.parseError=s.error:e.ast=s}}_getCellValue(e,t){const s=w(e,t);this._values.has(s)||this._evaluateCell(s,new Set);const r=this._values.get(s);return r&&typeof r=="object"&&r.error?NaN:r}_evaluateCell(e,t){const s=this._cells.get(e);if(!s){this._values.set(e,"");return}if(s.ast){if(t.has(e)){this._values.set(e,{error:"#CYCLE!"});return}t.add(e);const r={getCell:(n,l)=>{const o=w(n,l);if(t.has(o))throw new D;this._values.has(o)||this._evaluateCell(o,t);const a=this._values.get(o);if(a&&typeof a=="object"&&a.error)throw new D(a.error);return a===void 0?"":a}};try{const n=F(s.ast,r);this._values.set(e,n)}catch(n){this._values.set(e,{error:n.code||"#CYCLE!"})}t.delete(e)}else{const r=s.raw;if(r===""||r==null){this._values.set(e,"");return}const n=parseFloat(String(r).replace(",","."));!isNaN(n)&&String(n)===String(r).replace(",",".").replace(/^\+/,"")?this._values.set(e,n):!isNaN(n)&&/^-?\d+([.,]\d+)?$/.test(String(r).trim())?this._values.set(e,n):this._values.set(e,String(r))}}_recompute(){this._values.clear();for(const e of this._cells.keys())this._values.has(e)||this._evaluateCell(e,new Set)}_render(){this._readAttrs(),this._pickTarget(),this.innerHTML="",this.setAttribute("data-mode",this._mode),this._recompute(),this._buildDom(),this._mode==="identify-zones"?(this._applyPresetSelections(),this._buildIdentifyZones()):this._mode==="cell-name"||this._mode==="range-name"?(this._applyTargetPreset(),this._buildNamingPanel()):(this._mode==="cell-click"||this._mode==="range-drag")&&this._buildClickInstruction(),this._updatePhase(),M(()=>import("./rapido-engine.CMPXk0MX.js").then(e=>e.h),__vite__mapDeps([0,1,2])).then(e=>e.wireCardInputs?.(this.closest(".q-card")))}_pickTarget(){const e=Array.isArray(this._preset?.targets)?this._preset.targets:null;e&&e.length>0?this._currentTarget=e[Math.floor(Math.random()*e.length)]:this._currentTarget=(this._preset?.target||"").trim(),this._declaredMode==="cell"?this._mode=Math.random()<.5?"cell-click":"cell-name":this._declaredMode==="range"&&(this._mode=Math.random()<.5?"range-drag":"range-name")}randomize(){this._render()}_applyTargetPreset(){if(!this._tbody||this._preset?.noHighlight)return;const e=this._currentTarget;if(e)if(e.includes(":")){const[t,s]=e.split(":"),r=q(t),n=q(s);if(!r||!n)return;const l=Math.min(r.col,n.col),o=Math.max(r.col,n.col),a=Math.min(r.row,n.row),i=Math.max(r.row,n.row);for(let c=a;c<=i;c++)for(let u=l;u<=o;u++)this._cellElement(u,c)?.classList.add("ss-user-sel")}else{const t=q(e);if(!t)return;this._cellElement(t.col,t.row)?.classList.add("ss-user-sel","ss-user-sel-anchor")}}_buildNamingPanel(){const e=this._currentTarget,t=this._mode==="range-name",s=!!this._preset?.noHighlight,r=document.createElement("div");r.className="ss-vocab-panel";const n=t?"ex. B2:D4":"ex. C5",l=s?`<div class="ss-vocab-panel-title">${this._buildTargetDescription(e,t)}</div>`:"";r.innerHTML=`
    ...
    `,this.appendChild(r)}_buildTargetDescription(e,t){if(!e)return"";if(t){const[r,n]=e.split(":"),l=q(r),o=q(n);if(!l||!o)return`→ Plage : ${e}`;const a=Math.min(l.col,o.col),i=Math.max(l.col,o.col),c=Math.min(l.row,o.row),u=Math.max(l.row,o.row);return`→ Plage du coin <strong>colonne ${R(a)}, ligne ${c+1}</strong> jusqu'au coin <strong>colonne ${R(i)}, ligne ${u+1}</strong>.`}const s=q(e);return s?`→ Colonne <strong>${R(s.col)}</strong>, ligne <strong>${s.row+1}</strong>.`:`→ Cellule : ${e}`}_buildClickInstruction(){const e=this._currentTarget,t=document.createElement("div");t.className="ss-vocab-panel",t.innerHTML=`
