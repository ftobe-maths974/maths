import{l as S}from"./rapidos-visuals-integration.DWCmnuP8.js";import"./editor.CJZspgfY.js";const z="content",N=!0,u=(n,e)=>Math.floor(Math.random()*(e-n+1))+n,h=(n,e)=>{let t;do t=u(n,e);while(t===0);return t};function O(n){const e=n&&n.form||"ax+b=c";if(e==="ax=b"){const s=u(2,7),o=u(2,9);return{...n,equation:`${s}x = ${s*o}`,_seed:Math.random()}}if(e==="x+a=b"){const s=u(1,9),o=u(2,9);return{...n,equation:`x + ${s} = ${s+o}`,_seed:Math.random()}}if(e==="x+a=b-relatif"){let s,o,i;do s=h(-9,9),o=h(-9,9),i=o+s;while(i===0||Math.abs(i)>12);const l=s<0?` - ${-s}`:` + ${s}`;return{...n,equation:`x${l} = ${i}`,_seed:Math.random()}}if(e==="ax=b-relatif"){let s,o;do s=u(-7,7),o=h(-9,9);while(Math.abs(s)<2);const i=s*o,l=s<0?`-${-s}`:`${s}`;return{...n,equation:`${l}x = ${i}`,_seed:Math.random()}}if(e==="ax+b=cx+d"){let s,o,i,l,d;do s=u(3,7),o=u(1,s-1),i=u(2,6),l=u(1,12),d=l-i*(s-o);while(d<=0||d>12);return{...n,equation:`${s}x + ${d} = ${o}x + ${l}`,_seed:Math.random()}}if(e==="ax+b=cx+d-relatif"){let s,o,i,l,d;do s=h(-5,5),o=h(-4,4),i=h(-6,6),l=u(-8,8),d=l-i*(s-o);while(s===o||Math.abs(d)>15);const p=s<0?`-${-s}`:`${s}`,f=o<0?`-${-o}`:`${o}`,k=d<0?` - ${-d}`:` + ${d}`,q=l<0?` - ${-l}`:` + ${l}`;return{...n,equation:`${p}x${k} = ${f}x${q}`,_seed:Math.random()}}const t=u(2,7),r=u(2,7),a=u(1,9),c=t*r+a;return{...n,equation:`${t}x + ${a} = ${c}`,_seed:Math.random()}}const M=`
.ee-wrap {
  padding: 4px 8px;
  margin: 0 auto;
