const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["_astro/rapido-engine.CVZnbwpu.js","_astro/preload-helper.CLcXU_4U.js","_astro/rapidos-visuals-integration.D5WZZjeS.js","_astro/template-engine.D16pHiV0.js","_astro/js-yaml.CwjAzRNl.js","_astro/editor.Di92v2Ao.js"])))=>i.map(i=>d[i]);
import{_ as x}from"./preload-helper.CLcXU_4U.js";import{r as z}from"./rapido-engine.CVZnbwpu.js";import{randomize as I}from"./axe-gradue.0yqsoc5E.js";import"./rapidos-visuals-integration.D5WZZjeS.js";import"./template-engine.D16pHiV0.js";import"./js-yaml.CwjAzRNl.js";import"./editor.Di92v2Ao.js";const C="content",E=!0,y=`
...
.azf-help {
  ...
  /* Suit l'enonce .content : --q-text-size (slider webapp) ET --a4-font-scale
     (slider Police de l'apercu A4, defaut 1 ailleurs). Enfants en em -> suivent.
     0.8 = un cran plus petit que l'enonce (texte dense). */
  font-size: calc(var(--q-text-size, 1.1rem) * var(--a4-font-scale, 1) * 0.8);
}
.azf-help > summary {
  cursor: pointer;
  user-select: none;
