const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["_astro/fullscreen-viewer.Df4Z_CIe.js","_astro/editor.CJZspgfY.js","_astro/error-detector.3u6VZt3G.js"])))=>i.map(i=>d[i]);
import{_ as v}from"./editor.CJZspgfY.js";import{T as q,j as y}from"./fullscreen-viewer.Df4Z_CIe.js";const L=`# Matrice d'indices — fiche 24.04 retour à l'unité (cycle 3)
#
