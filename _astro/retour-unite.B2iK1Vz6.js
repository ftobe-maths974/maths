import{ensureSharedStyles as y}from"./vis-input.DJTCndhA.js";import{parseRange as k,fmt as w}from"./utils.MftNdmoG.js";import{b as x}from"./template-engine.BFEV3fMR.js";import"./preload-helper.CLcXU_4U.js";import"./rapido-engine.CwCsf_3V.js";import"./rapidos-visuals-integration.uALYzjaF.js";import"./editor.Di92v2Ao.js";import"./js-yaml.CwjAzRNl.js";const z="south",F=!0;function C(r){return r.replace(/\s/g,"").replace(",",".")}function l(r,e){const t=parseFloat(C(r));return!isNaN(t)&&Math.abs(t-e)<.01}const U=["dam","daL","min","m²","m³","°C","kg","mg","km","hm","cm","mm","dm","kL","hL","dL","cL","mL","Hz","g","t","m","L","A","V","W","h","s"].sort((r,e)=>e.length-r.length);function E(r){if(!r)return"";const e=String(r).trim();for(const i of U)if(e===i||e.startsWith(i)&&/[\s ]/.test(e.charAt(i.length)))return i;const t=e.match(/[A-Za-zÀ-ÿ]/);return t?t[0].toLowerCase():e.charAt(0)}const R=`
