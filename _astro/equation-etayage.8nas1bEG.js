import{l as _}from"./rapidos-visuals-integration.C7u2lp2a.js";import"./editor.CJZspgfY.js";const L="content",E=!0,p=(r,e)=>Math.floor(Math.random()*(e-r+1))+r,m=(r,e)=>{let t;do t=p(r,e);while(t===0);return t};function C(r){const e=r&&r.form||"ax+b=c";if(e==="ax=b"){const o=p(2,7),c=p(2,9);return{...r,equation:`${o}x = ${o*c}`,_seed:Math.random()}}if(e==="x+a=b"){const o=p(1,9),c=p(2,9);return{...r,equation:`x + ${o} = ${o+c}`,_seed:Math.random()}}if(e==="x+a=b-relatif"){let o,c,s;do o=m(-9,9),c=m(-9,9),s=c+o;while(s===0||Math.abs(s)>12);const l=o<0?` - ${-o}`:` + ${o}`;return{...r,equation:`x${l} = ${s}`,_seed:Math.random()}}const t=p(2,7),n=p(2,7),i=p(1,9),a=t*n+i;return{...r,equation:`${t}x + ${i} = ${a}`,_seed:Math.random()}}const k=`
.ee-wrap {
  padding: 12px 8px;
  margin: 0 auto;
