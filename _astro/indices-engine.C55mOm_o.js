const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["_astro/rapido-engine.B6LmgF-X.js","_astro/rapidos-visuals-integration.BdKcvLuB.js","_astro/editor.CJZspgfY.js","_astro/error-detector.Bq_g-vG1.js"])))=>i.map(i=>d[i]);
import{_ as x}from"./editor.CJZspgfY.js";import{T as A,j as E}from"./rapido-engine.B6LmgF-X.js";import"./rapidos-visuals-integration.BdKcvLuB.js";const C=`# Matrice d'indices — fiche 24.04 retour à l'unité (cycle 3)
#
