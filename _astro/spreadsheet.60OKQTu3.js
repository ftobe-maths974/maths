const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["_astro/rapido-engine.DMLycohL.js","_astro/rapidos-visuals-integration.Bt-B3w0n.js","_astro/editor.CJZspgfY.js","_astro/vis-input.DUlt-pNi.js"])))=>i.map(i=>d[i]);
import{_ as y}from"./editor.CJZspgfY.js";import{ensureSharedStyles as I}from"./vis-input.DUlt-pNi.js";import{parseFormula as v,evaluate as k,parseRef as w,idxToCol as S,formatValue as M,shiftRefs as A,stringify as R,astEqual as z}from"./formula-parser.CuBpGvtX.js";import"./rapido-engine.DMLycohL.js";import"./rapidos-visuals-integration.Bt-B3w0n.js";const V="east",W=!1,L="math974-spreadsheet-css",T=`
math974-spreadsheet {
  display: block;
  font-family: inherit;
  width: 100%;
...
/* La cellule de grille .q-card-content doit pouvoir shrinker. Sans min-width
   0 sur cette zone, le contenu impose sa taille minimum (ex. un mot long
   devient infiniment large) et le tableur east deborde. */
.q-card.has-visual-east .q-card-content {
  min-width: 0;
}
/* Le tableur dans .q-card-east ne deborde pas — overflow auto au cas ou
   les cellules au min-w (38px) ne suffisent pas en mobile portrait. */
.q-card.has-visual-east > .q-card-east {
  min-width: 0;
  max-width: 60cqw;
}
.q-card-east > .visual-wrapper {
  max-width: 100%;
  overflow: auto;
}
.ss-wrap {
