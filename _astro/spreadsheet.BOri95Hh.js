const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["_astro/rapido-engine.aQ3QetNc.js","_astro/rapidos-visuals-integration.BGF2vzla.js","_astro/editor.CJZspgfY.js","_astro/vis-input.btQWHIWd.js"])))=>i.map(i=>d[i]);
import{_ as y}from"./editor.CJZspgfY.js";import{ensureSharedStyles as I}from"./vis-input.btQWHIWd.js";import{parseFormula as v,evaluate as k,parseRef as w,idxToCol as S,formatValue as M,shiftRefs as A,stringify as R,astEqual as z}from"./formula-parser.CuBpGvtX.js";import"./rapido-engine.aQ3QetNc.js";import"./rapidos-visuals-integration.BGF2vzla.js";const V="east",W=!1,L="math974-spreadsheet-css",T=`
math974-spreadsheet {
  display: block;
  font-family: inherit;
  width: 100%;
...
/* Borne le scaling du .content parent quand un visuel spreadsheet y est
   monte. Le clamp(--q-text-size) global atteint 4rem en FS — beaucoup
   trop pour cohabiter avec le tableur en layout 3 colonnes (east).
   La regle s'applique au .variant-content marque .ss-variant par le composant. */
.variant-content.ss-variant > .content {
  font-size: clamp(0.9rem, 2.2cqi, 1.35rem);
  line-height: 1.35;
  text-align: left;
}
/* Le tableur prend sa taille naturelle dans .q-card-east, scroll horizontal
   si la grille deborde (mobile portrait notamment). */
.q-card-east > .visual-wrapper:has(math974-spreadsheet) {
  max-width: 100%;
  overflow: auto;
}
.ss-wrap {
