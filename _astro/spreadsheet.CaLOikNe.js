const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["_astro/rapido-engine.8EiiQxtg.js","_astro/rapidos-visuals-integration.CZlY4Kyx.js","_astro/editor.CJZspgfY.js","_astro/vis-input.B6JMwy7s.js"])))=>i.map(i=>d[i]);
import{_ as y}from"./editor.CJZspgfY.js";import{ensureSharedStyles as I}from"./vis-input.B6JMwy7s.js";import{parseFormula as v,evaluate as k,parseRef as w,idxToCol as S,formatValue as M,shiftRefs as R,stringify as A,astEqual as z}from"./formula-parser.CuBpGvtX.js";import"./rapido-engine.8EiiQxtg.js";import"./rapidos-visuals-integration.CZlY4Kyx.js";const V="east",W=!1,L="math974-spreadsheet-css",T=`
math974-spreadsheet {
  display: block;
  font-family: inherit;
  width: 100%;
...
/* HISTORIQUE LAYOUT — voir le header du module (en haut du fichier .js)
   pour le detail des essais. Resume : grid-template-columns 1fr 1fr (2
   colonnes egales) est la seule config qui marche dans tous les modes
   (caddy/1UP/FS/classe vignette) sans effondrement du tableur. */
.q-card .q-card-content { min-width: 0; }
.q-card.has-visual-east:has(math974-spreadsheet) {
