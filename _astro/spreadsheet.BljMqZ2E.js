const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["_astro/rapido-engine.BXSwL_-x.js","_astro/rapidos-visuals-integration.pS2LLYuz.js","_astro/editor.CJZspgfY.js","_astro/vis-input.e3aqZ10S.js"])))=>i.map(i=>d[i]);
import{_ as y}from"./editor.CJZspgfY.js";import{ensureSharedStyles as I}from"./vis-input.e3aqZ10S.js";import{parseFormula as v,evaluate as k,parseRef as w,idxToCol as S,formatValue as M,shiftRefs as A,stringify as R,astEqual as z}from"./formula-parser.CuBpGvtX.js";import"./rapido-engine.BXSwL_-x.js";import"./rapidos-visuals-integration.pS2LLYuz.js";const V="south",W=!1,L="math974-spreadsheet-css",T=`
math974-spreadsheet {
  display: block;
  font-family: inherit;
  width: 100%;
...
/* Borne le scaling du .content parent quand un visuel spreadsheet y est
   monté — sinon le clamp(--q-text-size) global atteint 4rem en FS et
   l'énoncé chevauche le tableur. La règle s'applique au .variant-content
   marqué `.ss-variant` par le composant. */
