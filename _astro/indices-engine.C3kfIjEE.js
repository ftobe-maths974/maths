const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["_astro/fullscreen-viewer.Bm1Cdz7m.js","_astro/editor.CJZspgfY.js","_astro/error-detector.D2HUDb5s.js"])))=>i.map(i=>d[i]);
import{_ as v}from"./editor.CJZspgfY.js";import{T as q,j as y}from"./fullscreen-viewer.Bm1Cdz7m.js";const L=`# Matrice d'indices — fiche 24.04 retour à l'unité (cycle 3)
#
