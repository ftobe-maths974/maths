import{ensureSharedStyles as G}from"./vis-input.CZAImgBH.js";import{parseRange as A}from"./utils.MftNdmoG.js";import"./preload-helper.CLcXU_4U.js";import"./rapido-engine.CVZnbwpu.js";import"./rapidos-visuals-integration.D5WZZjeS.js";import"./template-engine.D16pHiV0.js";import"./js-yaml.CwjAzRNl.js";import"./editor.Di92v2Ao.js";const re="south",ie=!0,se=!0,b=s=>Math.round(s*1e6)/1e6,$=s=>Number(b(s)).toLocaleString("fr-FR",{maximumFractionDigits:6}),O={7:"dizaines de millions",6:"millions",5:"centaines de mille",4:"dizaines de mille",3:"milliers",2:"centaines",1:"dizaines",0:"unités","-1":"dixièmes","-2":"centièmes","-3":"millièmes","-4":"dix-millièmes","-5":"cent-millièmes","-6":"millionièmes"};function I(s){let t=Math.abs(b(s)).toFixed(6),[i,a=""]=t.split(".");a=a.replace(/0+$/,""),i=i.replace(/^0+(?=\d)/,"");const c={};for(let o=0;o<i.length;o++)c[i.length-1-o]=i[o];for(let o=0;o<a.length;o++)c[-(o+1)]=a[o];const m=Object.keys(c).map(Number);return{digits:c,minRank:Math.min(0,...m),maxRank:Math.max(0,...m)}}function V(s){return String(s??"").replace(/\s/g,"").replace(",",".")}function j(s,e){const t=parseFloat(V(s));return!isNaN(t)&&Math.abs(t-e)<.001}const P=`
